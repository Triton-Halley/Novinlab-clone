        ...
        <div className={classes.container}>
          <div className={classes.BoxContainer}>
            <div className={classes.ContentContainer}>
              ...
              <p>
                ...
                اختصاصی ، نمونه گیری نوزادان و خردسالان و همچنین افراد مسن و کم
                توان را به شکلی ساده و با کم ترین احساس ناراحتی انجام می دهد.
              </p>
            </div>
            <div>
          ...
          <div className={classes.BoxContainer}>
            <div className={classes.ContentContainer}>
              ...
              <p>
                آزمایشگاه نوین برای رفاه حال شما عزیزان سیستم نمونه گیری در منزل
                و محل کار را در نظر گرفته است و شما می توانید بدون مراجعه حضوری
                پذیرش شده و از شما درمحل نمونه گیری خواهد شد.
              </p>
            </div>
            <div>
          ...
          <div className={classes.BoxContainer}>
            <div className={classes.ContentContainer}>
              ...
              <p>
                ...
                پیشرفته تصفیه هوا و ضدعفونی برای حفظ سلامت شما عزیزان در مراجعه
                حضوری می باشد. &nbsp; &nbsp;
                <br />
              </p>
            </div>
